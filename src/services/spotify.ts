...
export const authorization = async (clientId: string, clientSecret: string): Promise<string> => {
...
const fetchWebApi = async (token: string, endpoint: string, method: string, body: string | null = null): Promise<any> => {
...
//     token, 'v1/me/top/tracks?time_range=short_term&limit=5', 'GET'
//   )).items
// }
